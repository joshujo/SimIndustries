...
use crate::{
    core::{ Assets, Company, Player, WorldData },
    logic::game::{emit_data::{emit_data, DateTime, PlayerCompanyData}, systems::produce_goods},
};

pub fn main(world_data: &mut WorldData, app: &AppHandle) {
    let _player_company = update_player_data(world_data, app);
